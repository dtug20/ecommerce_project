...
const { emitCategoryCreated, emitCategoryUpdated, emitCategoryDeleted } = require("../utils/socketEmitter");
...
exports.deleteCategory = async (req,res,next) => {
  try {
    ...
    const result = await categoryServices.deleteCategoryService(categoryId);
